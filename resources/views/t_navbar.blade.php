    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="row  mt-2 mb-2">
          <a href="{{route('updatedetails',['id'=>$data->t_id])}}" class="col-sm-3 ml-3"><button class="btn btn-secondary"><i class="fas fa-user-tie"></i> Update</button></a>
          <a href="{{route('changePass',['id'=>$data->t_id])}}" class="col-sm-3 ml-3"><button class="btn btn-secondary"><i class="fas fa-user-cog"></i> Settings</button></a>
